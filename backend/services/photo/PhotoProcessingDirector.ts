 ...
 */
import ProcessedPhotoBuilder from './ProcessedPhotoBuilder';
...
export class PhotoProcessingDirector {
  /**
   ...
   */
  async process(buffer: Buffer, mimetype: string): Promise<{ originalBuffer: Buffer; thumbnailBuffer: Buffer; width: number; height: number; mimetype: string }> {
...
export default PhotoProcessingDirector;
