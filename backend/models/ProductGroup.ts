...
export type IProductGroup = InferSchemaType<typeof productGroupSchema>;
export type ProductGroupDocument = HydratedDocument<IProductGroup>;

export default model<IProductGroup>('ProductGroup', productGroupSchema);
